    ...
    <div className="min-h-screen bg-gray-100 pt-8">
      ...
      <div className="flex flex-col max-w-6xl mx-auto mt-8 rounded">
        <div className="relative w-full flex justify-center items-center">
          ...
          <label
            htmlFor="coverPhoto"
            className="absolute bottom-4 right-32 bg-white text-black py-2 px-4 rounded cursor-pointer text-sm flex items-center space-x-2 shadow-md hover:bg-gray-200 transition duration-200 z-10"
          >
            <CameraOutlined />
        ...
        <div className="w-full flex justify-center relative mt-8 bg-yellow-300">
          <div className="absolute -top-28 w-10/12 flex items-center p-4 rounded gap-8">
            ...
            <div className="flex flex-row flex-grow text-start relative pt-20 gap-64">
            <div className=''>
              <h1 className="text-3xl font-bold">Thomas Shelby</h1>
              <p className="text-gray-600 font-thin text-sm">4 Publish Inks</p>
              </div>
              <div className="mt-4 space-x-4">
                <button className="bg-violet-800 hover:bg-violet-700 text-white text-sm py-2 px-3  rounded">
                <PlusOutlined /> Write post
                </button>
                <button className="border border-violet-800 text-violet-800 text-sm py-2 px-3 rounded hover:bg-white-800 hover:text-violet-600 hover:border-violet-600">
